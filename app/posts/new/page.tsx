    ...
    <div className="min-h-screen bg-gray-50 dark:bg-gray-900 text-gray-900 dark:text-gray-100">
      <div className="max-w-screen-xl mx-auto">
                  ...
                  <div className={`flex ${isMobile ? 'space-x-1' : 'space-x-1'}`}>
                    ...
                    {!isMobile && (
                      <>
                        ...
                        {/* <button onClick={() => insertFormat('codeBlock')} className="p-2 text-gray-600 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-700 rounded-md">
                         size={18} />
                        </button> */}
                      </>
                    )}
        ...
        {/* {activeTab === "edit" ? (
          ...
          <div data-color-mode="light" className="p-4 rounded">
            <MDEditor.Markdown source={content} className="" />
          </div>
        )} */}
