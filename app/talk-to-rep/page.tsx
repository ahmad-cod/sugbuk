...
export default function TalkToRep() {
  return (
    <main className="w-full flex flex-col gap-10 sm:gap-20">
      <section className="w-full bg-gradient-to-r from-blue-400 to-blue-600 text-white py-12 p-4 sm:px-20">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="text-3xl md:text-4xl font-bold text-center">Talk to Your Representative</h1>
