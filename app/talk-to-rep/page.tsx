        ...
        <div className="container px-4">
          <div className="max-w-3xl mx-auto flex flex-col gap-12">
            <div className="rounded-lg shadow-lg p-6 md:p-8">
              <h2 className="font-heading text-2xl font-bold text-gray-800 mb-6">Submit Your Feedback</h2>
              <FeedbackForm />
            </div>
  ...
  return (
    <section className="w-full bg-gradient-to-r from-blue-400 to-blue-600 text-white px-4 py-12 sm:px-20">
        <div className="container max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <h1 className="font-heading text-3xl md:text-4xl font-bold text-center">Talk to Your Representative</h1>
          <p className="text-lg md:text-xl text-center mt-4 max-w-2xl mx-auto opacity-90">
            Share your concerns, feedback, or ideas with the Student Union Government.
